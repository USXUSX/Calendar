...
grep -Fq 'href="./styles.css?v=issue-31-1"' "$web_dir/index.html"
grep -Fq 'href="./styles.css?v=issue-31-1"' "$web_dir/trip.html"
...
grep -Fq 'f"{version}.json"' "$repo_root/scripts/serve_calendar.py"
grep -Fq 'requestedVersion === "candidate"' "$web_dir/app.js"
grep -Fq '候補版・未採用' "$web_dir/app.js"
grep -Fq 'view.candidateError' "$web_dir/app.js"
grep -Fq 'candidateProbe(candidateResponse)' "$web_dir/app.js"
grep -Fq 'applyCandidateReadOnly(app, readOnly)' "$web_dir/app.js"
