...
grep -Fq 'href="./styles.css?v=issue-25-3"' "$web_dir/index.html"
grep -Fq 'href="./styles.css?v=issue-25-3"' "$web_dir/trip.html"
...
grep -Fq 'function placeLinks(place)' "$web_dir/app.js"
grep -Fq '? "Google Maps" : "公式HP"' "$web_dir/app.js"
grep -Fq 'rel="noopener noreferrer"' "$web_dir/app.js"
