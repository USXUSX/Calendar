...
latest-only Working state, existing-item change/deletion, manually entered temporary-item positioning, and opaque day-instruction upsert and clearing, effective-revision staleness and confirmation blocking,
